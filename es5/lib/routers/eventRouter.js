...
var _controllersEventControllerJs = require("../controllers/eventController.js");

var _controllersEventControllerJs2 = _interopRequireDefault(_controllersEventControllerJs);

var EventRouter = (function (_Router) {
    _inherits(EventRouter, _Router);

    function EventRouter() {
        _classCallCheck(this, EventRouter);

        _get(Object.getPrototypeOf(EventRouter.prototype), "constructor", this).apply(this, arguments);
    }
